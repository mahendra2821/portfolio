...
// ✅ Your imported certificate images
import pic15 from "./assets/pic_15.png";
import pic16 from "./assets/pic_16.png";
import pic17 from "./assets/pic_17.png";
import pic18 from "./assets/pic_18.png";
...
const certifications = [
  { title: "Generative AI Mega Workshop", authority: "NXTWAVE ACADEMY", date: "Sep 2024", image: pic28 },
  { title: "Generative AI Mega WorkShop 2.0", authority: "NXTWAVE ACADEMY", date: "Sep 2024", image: pic27 },
  { title: "React Js", authority: "NXTWAVE ACADEMY", date: "Jul 2024", image: pic15 },
  { title: "Node Js", authority: "NXTWAVE ACADEMY", date: "Mar 2024", image: pic16 },
  { title: "Responsive Web Design", authority: "NXTWAVE ACADEMY", date: "Jan 2024", image: pic17 },
  { title: "Databases", authority: "NXTWAVE ACADEMY", date: "Dec 2023", image: pic18 },
  { title: "JavaScript Essentials", authority: "NXTWAVE ACADEMY", date: "Dec 2023", image: pic25 },
  { title: "Dynamic Web Application", authority: "NXTWAVE ACADEMY", date: "Oct 2023", image: pic24 },
  { title: "Python Foundations", authority: "NXTWAVE ACADEMY", date: "Sep 2023", image: pic23 },
  { title: "Computer Networks", authority: "IIT Kharagpur", date: "May 2024", image: pic19 },
  { title: "ChatGPT & AI Tools", authority: "Be10x", date: "Sep 2024", image: pic26 },
];
...
const Certifications = () => {
  ...
  return (
    <section id="certificates" className="relative w-[158vw] sm:w-full bg-black text-white py-16 overflow-hidden">
      ...
      {/* Title */}
      <motion.h2
        className="relative z-10 text-5xl font-extrabold text-center mb-14 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"
      ...
      <div className="overflow-hidden relative z-10">
        <motion.div
          ...
          animate={controls}
          whileHover={{ x: controls.stop }} // Pause on hover
        >
          {[...certifications, ...certifications].map((cert, index) => (
            <motion.div
              key={index}
              className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 p-4 min-w-[280px] cursor-pointer hover:shadow-cyan-500/50 transition-all"
              whileHover={{ scale: 1.08, rotate: 2 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => openModal(cert)}
            >
              <img src={cert.image} alt={cert.title} className="rounded-lg w-full h-44 object-cover" />
              <h3 className="text-lg font-bold mt-3 text-cyan-300">{cert.title}</h3>
              <p className="text-sm text-gray-300">{cert.authority}</p>
